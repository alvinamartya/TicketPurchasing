...
namespace TicketPurchasing.MenuAgency
{
    public partial class UclSaveToPDF : UserControl
    {
        ...
        private void UclSaveToPDF_Load(object sender, EventArgs e)
        {
            ...
            ReportDataSource reportDatasource = new ReportDataSource(); // datasource
            reportDatasource.Name = "DataSet1"; // nama data source di report
            reportDatasource.Value = ticketdataset.DataTable1; // value
